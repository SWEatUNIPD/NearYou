...
public class PointOfInterestTest {
  ...
  void testDifferentLat() {
    PointOfInterest pointOfInterestCopy =
        new PointOfInterest(80f, 78.5f, "IT101010101", "Test", "Test", "Test");
  ...
  void testDifferentLon() {
    PointOfInterest pointOfInterestCopy =
        new PointOfInterest(78.5f, 80f, "IT101010101", "Test", "Test", "Test");
    Assertions.assertNotEquals(pointOfInterest, pointOfInterestCopy);
  }
  ...
  void testDifferentVat() {
    PointOfInterest pointOfInterestCopy =
        new PointOfInterest(78.5f, 78.5f, "IT101010100", "Test", "Test", "Test");
    Assertions.assertNotEquals(pointOfInterest, pointOfInterestCopy);
  }
  ...
  void testDifferentName() {
    PointOfInterest pointOfInterestCopy =
        new PointOfInterest(78.5f, 78.5f, "IT101010101", "Test1", "Test", "Test");
    Assertions.assertNotEquals(pointOfInterest, pointOfInterestCopy);
  }
  ...
  void testDifferentCategory() {
    PointOfInterest pointOfInterestCopy =
        new PointOfInterest(78.5f, 78.5f, "IT101010101", "Test", "Test1", "Test");
    Assertions.assertNotEquals(pointOfInterest, pointOfInterestCopy);
  }
  ...
  void testDifferentOffer() {
    PointOfInterest pointOfInterestCopy =
        new PointOfInterest(78.5f, 78.5f, "IT101010101", "Test", "Test", "Test1");
    Assertions.assertNotEquals(pointOfInterest, pointOfInterestCopy);
  }
